...
// Div container where the app changes
...
// For Displaying & hiding sections
...
function changeTitleFormSubmitted(e) {
  ...
  // When it's a new list, add to the database
...
function settingsFormSubmitted(e) {
  ...
  // Reloading settings section with the new info
  displaySettings();
